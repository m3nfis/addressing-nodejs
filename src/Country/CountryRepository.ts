...
export class CountryRepository {
  ...
  private countryLists: Map<string, Record<string, string>> = new Map();
   ...
   */
  async get(countryCode: string): Promise<Country | null> {
   ...
   */
  async getList(locale: string = 'en'): Promise<Record<string, string>> {
    await this.initialize();
