 ...
 */
export class PostalLabelFormatter {
     ...
     */
    async formatAddress(address, addressFormat, country, options, isDomestic) {
     ...
     */
    getFieldValue(value, field, addressFormat) {
        if (!value) {
            return '';
        }
...
//# sourceMappingURL=PostalLabelFormatter.js.map